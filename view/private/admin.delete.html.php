                            ...
                            <div class="row justify-content-center">
                              <div class="col-md-10 col-lg-6 col-xl-5">
                                ...
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-primary">Supprimer</p>
                                  ...
                                  <a href="?delete=<?=$idDelete?>&ok"><button class="btn btn-danger me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe-americas me-2" viewBox="0 0 16 16">
