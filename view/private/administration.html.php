...
<tbody>
    <?php foreach($locations as $location) : ?>
        <tr>
            ...
            <td class="ps-4"><a href="?update=<?= $location['id'] ?>"><img src="img/edit.svg" alt="Icone modifier" width="30"></a></td>
            <td class="ps-4"><a href="?delete=<?= $location['id'] ?>"><img src="img/remove.svg" alt="Icone supprimer" width="30"></a></td>
        </tr>
    <?php endforeach ?>
</tbody>
            </table>
