...
<div class="container">
        <div class="row">
            <div class="col p-5">
        <h1 class="text-center">  <span class="text-primary">A</span><span class="text-danger">d</span><span class="text-warning">m</span><span class="text-primary">i</span><span class="text-success">n</span>Update.</h1>
        </div>
        </div>
</div>   
    <div class="content">
