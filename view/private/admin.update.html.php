                          ...
                          <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                              <div class="col-md-10 col-lg-6 col-xl-5">
                                ...
                                <p class="text-center h1 fw-bold mb-3 mx-1 mx-md-4 mt-4 text-primary">Modifier la data</p>
                                ...
                                <form action="" name="localisations" method="POST" [12:42] kevin Vanwassenhove
                                  ...
                                  <button type="submit" name="up" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" me-2 bi bi-globe-americas" viewBox="0 0 16 16">
