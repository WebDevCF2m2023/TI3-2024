            ...
            <?php endif; ?>
                ...
                <form class="col-12 col-md-8 col-xl-6 m-auto needs-validation <?= isset($secure) ? 'was-validated' : ''?>" novalidate method="POST">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nom" pattern="^.{1,50}$" value="<?= isset($secure) ? $_POST["name"] : $update["nom"]?>" required>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="adresse" id="adresse" placeholder="Adresse" pattern="^.{1,100}$" value="<?= isset($secure) ? $_POST["adresse"] : $update["adresse"]?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="codePostal" id="codepostal" placeholder="Code Postal" pattern="^\d\d\d\d$" value="<?= isset($secure) ? $_POST["codePostal"] : $update["codepostal"]?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="country" id="country" placeholder="Ville" pattern="^.{1,20}$" value="<?= isset($secure) ? $_POST["country"] : $update["ville"]?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" oninput="checkCorrectURL()" name="url" id="url" placeholder="Lien du site" pattern="^.{1,200}$" value="<?= isset($secure) ? $_POST["url"] : $update["url"]?>" required>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="latitude" id="lat" pattern="^-?\d{1,2}(\.\d{1,6})?$" placeholder="Exemple: 50.25647" value="<?= isset($secure) ? $_POST["latitude"] : $update["latitude"]?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="longitude" id="long" pattern="^-?\d{1,2}(\.\d{1,6})?$" placeholder="Exemple: 1.21456" value="<?= isset($secure) ? $_POST["longitude"] : $update["longitude"]?>" required>
                        <div class="invalid-feedback">
