    ...
    <div class="row w-auto">
              <div class="col">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control text-center" name="itemTypeInp" id="typeInp" aria-describedby="itemTypeField" placeholder="Type">
                 </div>
                 <div class="form-group">
                   <label for="itemAdd">Adresse</label>
                   <input type="text" class="form-control text-center" name="itemAddInp" id="addInp" aria-describedby="itemAddField" placeholder="Adresse">
                 </div>
                 <div class="form-group">
                   <label for="itemCode">Code Postal</label>
                   <input type="text" class="form-control text-center" name="itemCodeInp" id="codeInp" aria-describedby="itemCodeField" placeholder="Code Postal">
                 </div>
              </div>
                 <div class="col">
                 <div class="form-group">
                   <label for="itemVille">Ville</label>
                   <input type="text" class="form-control text-center" name="itemVilleInp" id="villeInp" aria-describedby="itemVilleField" placeholder="Type">
                 </div>
                 <div class="form-group">
                   <label for="itemUrl">URL</label>
                   <input type="text" class="form-control text-center" name="itemUrlInp" id="urlInp" aria-describedby="itemUrlField" placeholder="URL">
                 </div>
                 <div class="form-group">
