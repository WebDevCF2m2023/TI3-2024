...
<div class="container-fluid">
    ...
    <div class="collapse-sm navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        <a class="nav-link active animate__animated animate__delay-1s animate__fadeIn" href="?page=showmap">Carte</a>
        </li>
        <li class="nav-item">
        <a class="nav-link animate__animated animate__delay-2s animate__fadeIn" aria-current="page" href="?page=adminHome">Gérer les Lieux</a>
        </li>
      <li class="nav-item">
