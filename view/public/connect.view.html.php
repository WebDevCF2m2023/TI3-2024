...
<div id="content">
        <h3 class="text-center mt-5">Connexion à notre administration</h3>
        <?php if (isset($error)) : ?>
            ...
            <div class="row align-items-center g-lg-5 py-5">
                ...
                <div class="col-md-10 mx-auto col-lg-5">
                    <form method="POST" name="connexion" action="" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="floatingPassword" placeholder="Votre mot de passe" name="passwd">
