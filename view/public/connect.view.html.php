                ...
                <div class="col-md-10 mx-auto col-lg-5">
                    <form method="POST" name="connexion" action="" class="p-4 p-md-5 border rounded-3" id="loginForm">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Votre login" name="username" style="background-color: #f0f0f0;">
                            <label for="username">Login</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="floatingPassword" placeholder="Votre mot de passe" name="passwd" style="background-color: #f0f0f0;">
