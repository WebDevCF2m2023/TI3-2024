...
if(isset($_GET['insert'])){
    ...
    if(isset(
        ...
        $insert = addlocalisations($connect,$nom,$adresse,$latitude,$longitude);
        if($insert === true){
            header("Location: ./");
            exit();
        }else{
...
if(isset($_GET['update'])&&ctype_digit($_GET['update'])){
    ...
    // appel de la vue d'insertion
    require "../view/private/admin.update.view.html.php";
    //var_dump($_POST);
    exit();
...
if(isset($_GET['delete'])&&ctype_digit($_GET['delete'])){
    ...
    require "../view/private/admin.delete.view.html.php";
    exit();
}
...
require "../view/private/admin.homepage.view.html.php";