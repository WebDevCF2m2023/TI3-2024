...
if(isset($_GET['create'])){
    ...
    if(isset(
       ...
       $insert = insertOneGeolocByID($db,$nom,$adresse, $codepostal,$latitude, $longitude);
...
if(isset($_GET['update'])&&ctype_digit($_GET['update'])){
    ...
    if(isset(
        ...
        $_POST['longitude']
            ...
            $update = updateOneGeolocByID($db,$idgeoloc,$nom,$adresse,$codepostal,$latitude,$longitude);
            //var_dump($update);
            // update ok
            if($update===true){
                header("Location: ./");
