    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-center justify-content-center">
          <h2 class="ml-lg-2">Gestion des Bibliothèques</h2>
        </div>
        ...
        <tr>
          <th>
            <span class="custom-checkbox">
                ...
                <td><a href="?update=<?=$item['id']?>"><img src="img/update.png"  class="btn btn-success" data-toggle="modal"></td>
                <td><a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal">
		  <i class="material-icons">&#xE15C;</i> <span>Supprimer</span></a></a></td>
                <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
          <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
		  <i class="material-icons">&#xE147;</i> <span>Ajouter une Bibliothèque</span></a>
