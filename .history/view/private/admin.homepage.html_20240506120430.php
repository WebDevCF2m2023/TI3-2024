        ...
        <tr>
          <th>
            <span class="custom-checkbox">
                ...
                <td><a href="?update=<?=$item['id']?>"><i class="btn btn-success">&#xE147;</i> <span>Ajouter une Bibliothèque</span></a></td>
                <td><a href="?delete=<?=$item['id']?>"><i class="btn btn-danger ">&#xE15C;</i> <span>Supprimer</span></a></td>
                <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                <!--  <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
		  <i class="material-icons">&#xE147;</i> <span>Ajouter une Bibliothèque</span></a>
          <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal">
