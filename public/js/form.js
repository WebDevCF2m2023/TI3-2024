...
function checkInput() {
  ...
  if (fullNameValue === "") {
    ...
    setErrorMessage(
      fullName,
      "This field minimum character is 3. Please input at this range."
    );
  ...
  if (ageValue === "") {
    ...
    setErrorMessage(
      age,
      "This field minimum age is 18 . Please input at this range."
    );
  ...
  if (passwordValue === "") {
    ...
    setErrorMessage(
      password,
      "Password field can't be blank. Required this field."
    );
  ...
  if (checkPasswordValue === "") {
    ...
    setErrorMessage(
      checkPassword,
      "Sorry! Your define password and Retype password not match. Please input correct password."
    );
